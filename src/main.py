...
if __name__ == "__main__":
    ...
    chronic_df = get_chronic_data('https://chronicdata.cdc.gov/api/views/y6uv-ajdr/rows.csv?accessType=DOWNLOAD')
    ...
    analyze_aw_fb_data(aw_fb_df, save_dir=RESULTS_DIR)
    ...
    disease_counts, disease_sex, disease_age = analyze_assigned_diseases(full_df, save_dir=RESULTS_DIR)
